...
def questionBalance_99(name, nota_MT, dfResult):
    ...
    dfResult_MT = dfResult[dfResult['SG_AREA'] == 'MT']
    dfResultInterc = dfResult_MT[dfResult_MT['theta_065'] <= nota_MT+50]
    dfResultInterc = dfResult_MT[dfResult_MT['theta_065'] >= nota_MT-101]
