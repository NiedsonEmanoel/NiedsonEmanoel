...
dados <- read.delim("F:/Niedson Emanoel/Desktop/dados.txt")
View(dados)
...
write.csv(dados_com_notas, file = "F:/Niedson Emanoel/Desktop/dados_com_notas.csv", row.names = FALSE)
